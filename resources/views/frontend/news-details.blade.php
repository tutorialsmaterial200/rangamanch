        ...
        <div class="row">
            ...
            <div class="col-md-8">
                    ...
                    <div class="wrap__article-detail-content">
                        <div class="total-views">
                            <div class="total-views-read">
                                {{ convertToNepaliKFormat($news->views) }}
                                <span>
                                    {{ __('frontend.views') }}
                                </span>
                            </div>
                ...
                <div id="comments" class="comments-area">
                    <h3 class="comments-title">{{ nepaliCount($news->comments()->count()) }} {{ __('frontend.Comments:') }}</h3>
                            ...
                            <aside class="comment-body">
                                <div class="comment-meta">
                                    ...
                                    <div class="comment-metadata">
                                        <a href="javascript:;">
                                            <span>{{ getNepaliDateTime($comment->created_at) }}</span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <li class="comment">
                                    <aside class="comment-body">
                                        <div class="comment-meta">
                                            ...
                                            <div class="comment-metadata">
                                                <a href="javascript:;">
                                                    <span>{{ getNepaliDateTime($reply->created_at) }}</span>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="article__entry">
                                ...
                                <div class="article__content">
                                    <ul class="list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <span>
                                                {{ getNepaliShortDate($post->created_at) }}
                                            </span>
                                        </li>
                            ...
                            <a href="{{ $socialCount->url }}" target="_blank">
                                <div class="social__media__widget mt-2" style="background-color:{{ $socialCount->color }}">
                                    ...
                                    <span class="social__media__widget-counter">
                                        {{ convertToNepaliKFormat($socialCount->fan_count) }} {{ $socialCount->fan_type }}
                                    </span>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="{{ route('news', ['tag' => $tag->name]) }}">
                                        #{{ $tag->name }} ({{ nepaliCount($tag->count) }})
                                    </a>
                                </li>
                                @endforeach
