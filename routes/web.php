...
Route::get('/video', [VideoGalleryController::class, 'index'])->name('video-gallery');
...
/** Admin AI Content Generation Route */
// Route::get('admin/ai', [AIController::class, 'index'])->name('admin.ai.index');
// Route::post('admin/ai/generate', [AIController::class, 'generate'])->name('admin.ai.generate');
